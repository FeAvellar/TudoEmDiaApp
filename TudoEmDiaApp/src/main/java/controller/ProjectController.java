...
public class ProjectController {
	...
	public void save(Project project) {
		...
		try {
			...
			stmt.setDate(3, (Date) project.getCreatedAt());
			stmt.setDate(4, (Date) project.getUpdatedAt());
	...
	public List<Project> getAll() {
		...
		try {
			...
			while (rset.next()) {
				...
				Project project = new Project(0, sql, sql, null, null); // observar se devo remover nas próxiams aulas
